...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb://21090070:21090070@localhost:27017/21090070?authSource=auth"
app.config["UPLOAD_FOLDER"] = "/home/student/21090070/"
...
class User:
    def _init_(self, email, name, password, age, gender, image_url=None):
        self.email = email
        self.name = name
